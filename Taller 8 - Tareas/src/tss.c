...
tss_t tss_create_user_task(paddr_t code_start) {
  ...
  //Si porque recibe la direccion fisica del inicio de las dos paginas de codigo y 
  //devuelve la direccion del directorio de tablas de paginas que es lo que se guarda en el cr3
