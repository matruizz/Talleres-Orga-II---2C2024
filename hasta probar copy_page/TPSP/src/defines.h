...
#define FLAT_SEGM_SIZE 0x33100000 //Esto que esta aca es 817*(2^20)
#define VIDEO_SEGM_SIZE 0x00001F40
...
*/
#define VIRT_PAGE_OFFSET(X) (X & 0x00000111)
#define VIRT_PAGE_TABLE(X)  ((X << 10) >> 22)
#define VIRT_PAGE_DIR(X)    (X >> 22)
#define CR3_TO_PAGE_DIR(X)  (X  & 0xFFFFF000)
#define MMU_ENTRY_PADDR(X)  (X << 12) // X * 4KB
