...
present: Si el segmento esta presente en memoria
DPL: El nivel de privilegio del descriptor (0 en este caso)
Type: Que representa nuestra en trada en la idt
Offset: La direccion de memoria donde comieza nuestro manejo de la interrupcion en cuestion
selector: Indica que selector debe ejecutar el codigo de la rutina
...
El selector de segmento apropiado seria el de codigo de nivel 0, es decir el 0b1000.
En el caso de 32 bits, no podriamos settear el atributo type como uno que haga referencia a un gate size de 16 bits
...
En este caso, el prologo y epilogo de estas rutinas serian el pushad y el popad correspondientemente, puesto que, al tratarse de una interrupcion, debe de preservar todos los registros. Luego, utilizamos el iret, ya que, en el transcurso de la interrupcion, podriamos modificar las flags, es por eso que debemos retornar las flags tal cual estaban anteriormente.
